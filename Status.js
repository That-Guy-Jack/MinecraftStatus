    ...
    .then((response) => {
    	...
    	var randomItem = colorArray[Math.floor(Math.random()*colorArray.length)];
    		const StatusEmbed = new Discord.MessageEmbed()
				.setTitle(servername)
				.setURL(serverurl)
				//.setThumbnail('https://cdn.discordapp.com/attachments/747770403329409107/789215350612164618/default.png')
				.setThumbnail('https://cdn.discordapp.com/attachments/747770403329409107/789216180703461396/spinn.gif')
